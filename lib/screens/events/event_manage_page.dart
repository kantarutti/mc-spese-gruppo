...
class EventManagePage extends ConsumerStatefulWidget {
  final String eventoId;

  const EventManagePage({super.key, required this.eventoId});

  @override
  ConsumerState<EventManagePage> createState() => _EventManagePageState();
}

class _EventManagePageState extends ConsumerState<EventManagePage> {
  ...
  Future<void> _salvaEvento(Evento evento) async {
    try {
      // TODO: Implementare salvataggio evento
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  enabled: false,
                  initialValue: evento.tipoEvento,
                  decoration: const InputDecoration(
